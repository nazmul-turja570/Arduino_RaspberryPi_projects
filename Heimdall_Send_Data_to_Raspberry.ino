...
const char* ssid = "Aula230";
const char* password = "sadiklisa";
...
void loop() {
  ...
  if (now - lastMeasure > 10000) {
    ...
    float water = get_data_from_sonar();
    static char waterPercent[7];
    dtostrf(water, 6, 2, waterPercent);

    // Publishes Temperature and Humidity values
    client.publish("/esp8266/temperature", temperatureTemp);
    client.publish("/esp8266/humidity", humidityTemp);
    // Publishes Sonar Data Values
    client.publish("/esp8266/waterPercent",waterPercent);
